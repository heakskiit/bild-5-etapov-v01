...
export async function POST(request: Request) {
  ...
  if (!user) {
    console.warn('[queue/claim] rejected: no session on the request');
  ...
  if (eventError) console.error('[queue/claim] event insert failed (claim itself still succeeded)', eventError);
